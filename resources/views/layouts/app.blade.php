                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <a href="{{ route('event.konvensi') }}"
                                class="block px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-500 rounded-b-lg">Konvensi</a>
                        </div>
                    </div>
            ...
            <div class="px-4 py-3 space-y-2">
                ...
                <div class="px-4 py-2">
                    ...
                    <div class="ml-4 mt-2 space-y-1">
                        ...
                        <a href="{{ route('event.konvensi') }}"
                            class="block px-4 py-2 text-gray-600 hover:text-orange-500">Konvensi</a>
                    </div>
                </div>
                <div class="px-4 py-2">
                    <a href="{{ route('artikel.index') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        @if (!empty($site_settings['footer_facebook']))
                            <a href="{{ $site_settings['footer_facebook'] }}" target="_blank"
                        ...
                        @endif
                        @if (!empty($site_settings['footer_twitter']))
                            <a href="{{ $site_settings['footer_twitter'] }}" target="_blank"
                                class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                        ...
                        @endif
                        @if (!empty($site_settings['footer_instagram']))
                            <a href="{{ $site_settings['footer_instagram'] }}" target="_blank"
                                class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                        ...
                        @endif
                        @if (!empty($site_settings['footer_linkedin']))
                            <a href="{{ $site_settings['footer_linkedin'] }}" target="_blank"
                                class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        @if (!empty($quick_links))
                            ...
                            @endforeach
                        @else
                            <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Beranda</a>
                            </li>
                            <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Tentang
                                    Kami</a></li>
                            <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Layanan</a>
                            </li>
                            <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Berita</a>
                            </li>
                            <li><a href="#" class="text-gray-400 hover:text-orange-500 transition">Kontak</a>
                            </li>
                        @endif
                    </ul>
                </div>
