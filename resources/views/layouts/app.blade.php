            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <a href="{{ !empty($site_settings['footer_facebook']) ? $site_settings['footer_facebook'] : '#' }}"
                            {{ !empty($site_settings['footer_facebook']) ? 'target="_blank"' : '' }}
                        ...
                        <a href="{{ !empty($site_settings['footer_twitter']) ? $site_settings['footer_twitter'] : '#' }}"
                            {{ !empty($site_settings['footer_twitter']) ? 'target="_blank"' : '' }}
                            class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="{{ !empty($site_settings['footer_instagram']) ? $site_settings['footer_instagram'] : '#' }}"
                            {{ !empty($site_settings['footer_instagram']) ? 'target="_blank"' : '' }}
                            class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="{{ !empty($site_settings['footer_youtube']) ? $site_settings['footer_youtube'] : '#' }}"
                            {{ !empty($site_settings['footer_youtube']) ? 'target="_blank"' : '' }}
                            class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
