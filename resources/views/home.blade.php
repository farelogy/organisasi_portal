...
@section('content')
                ...
                @foreach ($heroes as $hero)
                    <div class="hero-slide absolute inset-0 {{ $loop->first ? 'active' : '' }}"
                        ...
                        <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 h-full flex items-center">
                            ...
                            <div
                                class="absolute top-20 left-10 w-20 h-20 bg-orange-400/20 rounded-full blur-xl animate-pulse">
                            </div>
                            <div
                                class="absolute top-40 right-20 w-32 h-32 bg-orange-300/10 rounded-full blur-2xl animate-pulse delay-1000">
                            </div>
                            <div
                                class="absolute bottom-32 left-1/4 w-24 h-24 bg-orange-500/15 rounded-full blur-xl animate-pulse delay-500">
                            </div>

                            <div class="w-full lg:w-1/2 relative">
                                <div
                                    class="inline-flex items-center px-4 py-2 bg-orange-500/20 backdrop-blur-sm rounded-full border border-white/20 text-sm text-orange-100 mb-6">
                                    <span class="w-2 h-2 bg-orange-400 rounded-full mr-2 animate-pulse"></span>
                                    Persatuan Insinyur Indonesia
                                </div>
                                <div
                                    class="bg-orange-500/10 backdrop-blur-md rounded-3xl p-8 md:p-10 border border-orange-400/20 shadow-2xl mb-8">
                                    <h1
                                        class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
                                        {{ $hero->title }}
                                    </h1>
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-4">
                                        ...
                                        @endif
                                        <a href="#berita"
                                            class="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white rounded-2xl font-semibold text-lg hover:bg-white/20 transition-all duration-300 border border-white/20">
                                            Berita Terbaru
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-[100] flex items-center gap-3">
                    @foreach ($heroes as $index => $hero)
                        <button onclick="goToSlide({{ $index }})"
                            class="carousel-dot {{ $index === 0 ? 'active' : '' }}" data-index="{{ $index }}"
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                <div
                    ...
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19 11H5m14 0a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                    Berita Terkini
                </div>
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Dapatkan berita terbaru seputar kegiatan, program, dan inisiatif PII yang penting untuk anggota dan
                    masyarakat.
                </p>
                    ...
                    <div class="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100"
                        ...
                        <div class="p-8">
                            <div class="text-gray-400 text-sm mb-3">
                                {{ $berita->published_at?->format('d M Y') ?? 'Tanggal belum tersedia' }} •
                                {{ $berita->author ?? 'PII' }}
                            </div>
                            <h3 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-orange-500 transition-colors">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <p class="text-xl text-gray-300 max-w-3xl mx-auto">
                    Ikuti berbagai seminar, workshop, dan konferensi yang akan memperkaya pengetahuan dan jaringan
                    profesional Anda
                </p>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-2" data-aos="fade-up" data-aos-delay="200">
                @forelse($galleries->take(10) as $gallery)
                    <a href="{{ route('gallery') }}"
                        ...
                        <div
                            class="absolute inset-0 bg-orange-500/0 group-hover:bg-orange-500/20 transition-colors duration-300 rounded-xl">
                        </div>
                    </a>
                @empty
    ...
    <section id="kontak"
        class="py-24 bg-gradient-to-br from-slate-900 via-orange-900 to-slate-800 relative overflow-hidden">
        <!-- Background Elements -->
        <div class="absolute inset-0">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white space-y-8" data-aos="fade-right">
                    <div class="space-y-4">
                        ...
                        <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                            Siap untuk <span
                                class="bg-gradient-to-r from-orange-400 to-orange-200 bg-clip-text text-transparent">Berkembang</span>?
                        </h2>
                        <p class="text-xl text-gray-300 leading-relaxed max-w-lg">
                            Jadilah bagian dari komunitas insinyur terbesar di Indonesia. Dapatkan akses ke pelatihan,
                            networking, dan kesempatan karier yang tak terbatas.
                        </p>
                    </div>
                ...
                <div class="relative" data-aos="fade-left">
                    <div class="relative">
                        <!-- Main Visual -->
                        <div
                            class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/20">
                            <div class="text-center space-y-6">
                                <div
                                    class="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-300">Bergabunglah dengan komunitas insinyur terbesar di Indonesia
                                    </p>
                                </div>
                        ...
                        <!-- Floating Elements -->
                        <div
                            class="absolute -top-4 -left-4 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 animate-bounce delay-300">
                            <div class="flex items-center space-x-3">
                        ...
                        <div
                            class="absolute -bottom-4 -right-4 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 animate-bounce delay-700">
                            <div class="flex items-center space-x-3">
