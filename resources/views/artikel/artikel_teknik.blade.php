        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="space-y-6" data-aos="fade-up">
                <div
                    ...
                    <span class="text-orange-300 text-sm font-medium">Newsletter</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-bold text-white">
                    Tetap Update dengan <span class="text-orange-400">Artikel Terbaru</span>
                </h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto pt-4">
                    <input type="email" placeholder="Masukkan email Anda"
                        class="flex-1 px-6 py-4 rounded-2xl border-0 focus:ring-2 focus:ring-orange-500 text-gray-900 placeholder-gray-500">
                    <button
                        class="px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-2xl font-semibold hover:from-orange-600 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Berlangganan
                    </button>
                </div>
            </div>
