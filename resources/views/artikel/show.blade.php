...
@section('content')
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Author Box -->
            <div class="mt-12 bg-gradient-to-r from-orange-50 to-orange-100/50 rounded-3xl p-8 border border-orange-200"
                data-aos="fade-up">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="text-center sm:text-left">
                        <h3 class="text-xl font-bold text-gray-900 mb-2">{{ $artikel->author }}</h3>
                        <p class="text-gray-600 mb-4">Penulis artikel ini. Untuk pertanyaan atau diskusi lebih lanjut
                            tentang topik ini, silakan hubungi melalui kontak yang tersedia.</p>
                        <a href="{{ route('artikel.index') }}"
                            class="inline-flex items-center text-orange-500 font-semibold hover:text-orange-600 transition">
                            <span>Lihat semua artikel dari penulis ini</span>
