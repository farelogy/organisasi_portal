...
@section('title', 'Regulasi Terbaru - PII')
...
@section('content')
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center text-white space-y-8" data-aos="fade-up">
                ...
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                    <span class="block">Regulasi</span>
                    <span
                        class="block bg-gradient-to-r from-orange-400 to-orange-200 bg-clip-text text-transparent">Terbaru</span>
                </h1>
                <p class="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
                    Informasi terkini tentang regulasi, kebijakan, dan standar yang berlaku di dunia keinsinyuran Indonesia.
                </p>
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16" data-aos="fade-up">
                    ...
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                        Regulasi <span class="text-orange-500">Terbaru</span>
                    </h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                        Informasi terkini tentang regulasi dan kebijakan di dunia keinsinyuran
                    </p>
                </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2">
                                <div class="relative h-64 lg:h-auto">
                                    ...
                                    <div class="absolute top-6 left-6">
                                        <span
                                            class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-full text-sm font-semibold shadow-lg">
                                ...
                                <div class="p-8 lg:p-12 flex flex-col justify-center">
                                    <div class="flex items-center mb-4">
                                        <span
                                            class="inline-block bg-red-100 text-red-800 text-xs px-3 py-1 rounded-full font-semibold capitalize mr-4">
                                            Regulasi Terbaru
                                        </span>
                                    ...
                                    <h3
                                        class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight hover:text-red-500 transition-colors">
                                        {{ $featured->title }}</h3>
                                    <p class="text-gray-600 mb-6 text-lg leading-relaxed">{{ $featured->excerpt }}</p>
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            <div
                                                class="w-12 h-12 bg-gradient-to-br from-red-400 to-red-600 rounded-full flex items-center justify-center mr-3">
    ...
    @else
        <!-- No Articles State -->
        <section class="py-24 bg-gradient-to-br from-white via-red-50 to-white relative overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center" data-aos="fade-up">
                    <div class="bg-white rounded-3xl shadow-xl p-12 border border-gray-100 max-w-2xl mx-auto">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Belum Ada Regulasi</h3>
                        <p class="text-gray-600 text-lg mb-6">Konten regulasi untuk kategori ini sedang dalam pengembangan.
                            Silakan kembali lagi nanti atau jelajahi kategori lain.</p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="{{ route('artikel.index') }}"
                                class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-semibold hover:from-red-600 hover:to-red-700 transition-all duration-300">
    ...
    <!-- Newsletter Section -->
    <section class="py-20 bg-gradient-to-r from-slate-900 via-red-900 to-slate-800 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
            <div class="absolute inset-0"
                style="background-image: radial-gradient(circle at 25% 25%, rgba(239,68,68,0.3) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(239,68,68,0.3) 0%, transparent 50%);">
            </div>
        </div>
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="space-y-6" data-aos="fade-up">
                <div
                    class="inline-flex items-center px-4 py-2 bg-red-500/20 backdrop-blur-sm rounded-full border border-red-400/30">
                    <svg class="w-4 h-4 text-red-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
                        </path>
                    </svg>
                    <span class="text-red-300 text-sm font-medium">Newsletter</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-bold text-white">
                    Tetap Update dengan <span class="text-red-400">Regulasi Terbaru</span>
                </h2>
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                    Berlangganan newsletter kami dan dapatkan informasi regulasi terkini langsung ke inbox Anda
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto pt-4">
                    <input type="email" placeholder="Masukkan email Anda"
                        class="flex-1 px-6 py-4 rounded-2xl border-0 focus:ring-2 focus:ring-red-500 text-gray-900 placeholder-gray-500">
                    <button
                        class="px-8 py-4 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-2xl font-semibold hover:from-red-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Berlangganan
                    </button>
                </div>
            </div>
