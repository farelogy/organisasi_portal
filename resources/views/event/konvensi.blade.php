...
<section class="relative py-24 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800 overflow-hidden">
    <div class="absolute inset-0 opacity-10" style="background-image: radial-gradient(circle at 25% 25%, rgba(168,85,247,0.3) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(255,107,53,0.3) 0%, transparent 50%);"></div>
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
        <div class="inline-flex items-center px-4 py-2 bg-purple-500/20 backdrop-blur-sm rounded-full border border-purple-400/30 mb-6">
        ...
        <h1 class="text-5xl md:text-6xl font-bold text-white mb-4">Konvensi <span class="bg-gradient-to-r from-orange-400 to-orange-200 bg-clip-text text-transparent">PII</span></h1>
        <p class="text-xl text-gray-300 max-w-2xl mx-auto">Konvensi nasional dan internasional persatuan insinyur Indonesia</p>
    </div>
</section>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap justify-center gap-4 mb-12" data-aos="fade-up">
            ...
            <a href="{{ route('event.konvensi') }}" class="px-6 py-3 bg-orange-500 text-white rounded-2xl font-semibold hover:bg-orange-600 transition-all duration-300 ring-2 ring-orange-300">Konvensi</a>
        </div>
        ...
        <div id="loading-indicator" class="hidden flex justify-center py-8">
            <div class="flex items-center space-x-2 text-orange-500">
                ...
                <span class="font-medium">Memuat konvensi...</span>
            </div>
        </div>
        @else
        <div class="text-center py-16">
            <div class="bg-white rounded-3xl shadow-xl p-12 border border-gray-100 max-w-2xl mx-auto">
                <div class="w-24 h-24 bg-purple-100 rounded-2xl flex items-center justify-center mx-auto mb-6 text-4xl">🏆</div>
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Belum Ada Konvensi</h3>
                <p class="text-gray-600 mb-6">Jadwal konvensi sedang dipersiapkan.</p>
