...
@section('content')
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            <div class="text-center text-white space-y-6" data-aos="fade-up">
                ...
                <h1 class="text-5xl md:text-6xl font-bold leading-tight">
                    ...
                    <span
                        class="block bg-gradient-to-r from-orange-400 to-orange-200 bg-clip-text text-transparent">Kegiatan
                        PII</span>
                </h1>
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">Seminar, pelatihan, dan konferensi untuk mengembangkan
                    kompetensi insinyur Indonesia</p>
    ...
    <section id="events" class="py-24 bg-white relative overflow-hidden">
        <div class="absolute inset-0 opacity-5">
            <div class="absolute inset-0" style="background-image: url('data:image/svg+xml,%3Csvg width="80" height="80"
                viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg
                fill="%23FF6B35" fill-opacity="0.1"%3E%3Ccircle cx="40" cy="40" r="4"
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Agenda <span
                        class="text-orange-500">Mendatang</span></h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Daftar lengkap seminar, pelatihan, dan konferensi PII</p>
            </div>
            ...
            @if ($events->total() > 0)
                ...
                <div class="flex flex-wrap justify-center gap-4 mb-12" data-aos="fade-up" data-aos-delay="100">
                    <a href="{{ route('event.index') }}"
                        class="px-6 py-3 bg-orange-500 text-white rounded-2xl font-semibold hover:bg-orange-600 transition-all duration-300 ring-2 ring-orange-300">Semua</a>
                    ...
                    <a href="{{ route('event.konferensi') }}"
                        class="px-6 py-3 bg-white text-gray-700 rounded-2xl font-semibold hover:bg-orange-100 hover:text-orange-700 transition-all duration-300 border border-gray-200">Konferensi</a>
                </div>
            ...
            @else
                <div class="text-center py-16" data-aos="fade-up">
                    <div class="bg-white rounded-3xl shadow-xl p-12 border border-gray-100 max-w-2xl mx-auto">
                        ...
                        <p class="text-gray-600 text-lg mb-6">Agenda kegiatan sedang dipersiapkan. Pantau terus halaman ini.
                        </p>
                        <a href="{{ route('home') }}"
                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-semibold hover:from-orange-600 hover:to-orange-700 transition-all duration-300">Kembali
                            ke Beranda</a>
                    </div>
                </div>
            @endif
    ...
    <section class="py-24 bg-gradient-to-r from-orange-500 to-orange-600 relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="space-y-8" data-aos="fade-up">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Jangan Lewatkan <span class="block">Event
                        Berikutnya</span></h2>
                <p class="text-xl text-orange-100 max-w-2xl mx-auto">Tingkatkan kompetensi dan perluas jaringan profesional
                    Anda bersama PII</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
