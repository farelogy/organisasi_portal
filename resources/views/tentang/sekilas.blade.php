                        ...
                        <div class="float-left mr-8 mb-4 md:mr-10 md:mb-6 w-full md:w-80 lg:w-96">
                            <div class="relative group">
                                ...
                                <div class="mb-8 rounded-2xl overflow-hidden shadow-lg">
                                    <img src="{{ Str::startsWith($sekilas->image, ['http://', 'https://']) ? $sekilas->image : asset($sekilas->image) }}"
                                        alt="{{ $sekilas->title }}" class="w-full h-auto object-cover">
                                </div>
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="space-y-8" data-aos="fade-up">
                ...
                <p class="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
                    Jadilah bagian dari PII yang terus berkembang dan berkontribusi untuk kemajuan profesi keinsinyuran di
                    Indonesia
                </p>
