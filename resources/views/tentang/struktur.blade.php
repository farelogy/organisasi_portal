            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 lg:p-16">
                ...
                <div class="mb-10" data-aos="zoom-in">
                    <div class="relative group">
                        <div class="absolute -inset-1 bg-gradient-to-br from-orange-300 to-orange-500 rounded-2xl blur opacity-20 group-hover:opacity-30 transition-opacity"></div>
                        <div class="relative rounded-2xl overflow-hidden shadow-lg border border-gray-100 bg-white p-2">
                            <img src="{{ Str::startsWith($struktur->image, ['http://', 'https://']) ? $struktur->image : asset($struktur->image) }}" alt="{{ $struktur->title }}" class="w-full h-auto object-contain rounded-xl">
                        </div>
                ...
                <div class="prose prose-lg prose-slate max-w-none text-gray-700 leading-[1.8]">
                    {!! $struktur->content ?? '<p class="text-gray-500 italic">Konten struktur organisasi sedang dalam pengembangan.</p>' !!}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="space-y-8" data-aos="fade-up">
            ...
            <p class="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
                Jadilah bagian dari organisasi profesional insinyur dan berkontribusi untuk kemajuan profesi keinsinyuran di Indonesia
            </p>
